...
public class Lose extends Action implements Callback {
    ...
    public Lose(Internationalization internationalization, PoolService poolService, UserService userService, BalanceService balanceService) {
    ...
    private String prepareText() {
        int stepNumber = poolService.getUserStep(user) - 1;
        ...
        text = text.replace(NUMBER_STEPS.getKey(), String.valueOf(pool.getSteps().size()));
