...
import static ua.corporation.memeclimb.config.Markup.SUPPORT_BUTTONS;

public class Support extends Action implements Callback {
    public static final String KEY = "help";

    public Support(Internationalization internationalization) {
    ...
    public SendMessage createSendMessage(Long chatId, String text) {
        return new SendMessage(chatId, text)
                .replyMarkup(SUPPORT_BUTTONS.get(internationalization));
    }
}
